...
RSpec.describe Katalyst::Turbo::TableComponent do
  ...
  it "creates a bare table" do
    expect(table).to match_html(<<~HTML)
      <table id="table" data-controller="tables--turbo-collection" data-tables--turbo-collection-url-value="/resource">
        <thead><tr></tr></thead>
        <tbody></tbody>
      </table>
    HTML
    ...
    it "creates a bare table" do
      expect(table).to match_html(<<~HTML)
        <table id="table"
               ...
               data-tables--turbo-collection-url-value="/resource?sort=name+desc">
          <thead><tr></tr></thead>
          <tbody></tbody>
        </table>
      HTML
    ...
    it "creates a bare table" do
      expect(table).to match_html(<<~HTML)
        <table id="table"
               ...
               data-tables--turbo-collection-url-value="/resource">
          <thead><tr></tr></thead>
          <tbody></tbody>
        </table>
      HTML
