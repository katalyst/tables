...
RSpec.describe Katalyst::Tables::Frontend::Builder do
  let(:table) { instance_double(Katalyst::Tables::Frontend::Builder) }
  ...
  describe Katalyst::Tables::Frontend::Builder::Body::Cell do
  ...
  describe Katalyst::Tables::Frontend::Builder::Header::Cell do
  ...
  describe Katalyst::Tables::Frontend::Builder::Body::Row do
    let(:object) { Test::Record.new(key: "VALUE") }
  ...
  describe Katalyst::Tables::Frontend::Builder::Header::Row do
    it "renders an empty row" do
